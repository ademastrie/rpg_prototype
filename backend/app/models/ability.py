...
class AbilityEffect(Base):
    ...
    damage_school: Mapped[str | None] = mapped_column(String(50), nullable=True)
    scaling_stat_key: Mapped[str | None] = mapped_column(String(50), nullable=True)
    scaling_ratio: Mapped[float | None] = mapped_column(Float, default=0, server_default="0", nullable=True)
